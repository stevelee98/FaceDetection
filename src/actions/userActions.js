...
export const forgetPass = (email, phone) => (
    {
...
export const updatePhoneNumber = (id, phone) => (
    {
        type: ActionEvent.UPDATE_PHONE_NUMBER,
        payload: { id, phone }
    }
)

export const updatePhoneNumberSuccess = data => ({
    type: getActionSuccess(ActionEvent.UPDATE_PHONE_NUMBER),
    payload: { data }
})
...
export const loginZalo = data => ({
    type: ActionEvent.LOGIN_ZALO,
    payload: data
})
export const loginZaloSuccess = data => ({
    type: getActionSuccess(ActionEvent.LOGIN_ZALO),
    payload: { data }
})
...
export const getAppointmentUpcoming = filter => ({
    type: ActionEvent.GET_APPOINTMENT_UPCOMING,
    payload: { ...filter }
})

export const getAppointmentUpcomingSuccess = data => ({
    type: getActionSuccess(ActionEvent.GET_APPOINTMENT_UPCOMING),
    payload: { data }
})

export const getAppointmentHistory = filter => ({
    type: ActionEvent.GET_APPOINTMENT_HISTORY,
    payload: { ...filter }
})

export const getAppointmentHistorySuccess = data => ({
    type: getActionSuccess(ActionEvent.GET_APPOINTMENT_HISTORY),
    payload: { data }
})
...
export const registerAppointment = filter => ({
    type: ActionEvent.REGISTER_APPOINTMENT,
    payload: { ...filter }
})

export const registerAppointmentSuccess = data => ({
    type: getActionSuccess(ActionEvent.REGISTER_APPOINTMENT),
    payload: { data }
})
...
export const getStaffs = () => ({
    type: ActionEvent.GET_STAFFS
})

export const getStaffsSuccess = data => ({
    type: getActionSuccess(ActionEvent.GET_STAFFS),
    payload: { data }
})
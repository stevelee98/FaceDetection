...
export const updateCoordinate = filter => ({
    type: ActionEvent.UPDATE_COORDINATE,
    payload: { ...filter }
})

export const updateCoordinateSuccess = data => ({
    type: getActionSuccess(ActionEvent.UPDATE_COORDINATE),
    payload: { data }
})
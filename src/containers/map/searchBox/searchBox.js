					...
					<InputGroup>
						...
						{this.props.isLoading
							...
							: <TouchableOpacity
								...
								<Image resizeMode={'contain'} source={!Utils.isNull(txtSearch) ? ic_close : ic_search} style={{
									width: 15, height: 15, marginRight: Constants.MARGIN_LARGE, marginLeft: Constants.MARGIN
								}} />
							</TouchableOpacity>
						}
					</InputGroup>

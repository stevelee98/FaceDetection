    ...
    action$.pipe(
        ...
        switchMap((action) =>
            fetch(ServerPath.API_URL + `product/category`, {
                ...
                console.log(responseJson)
                return productActions.getProductCategoryInHomeSuccess(responseJson)
            })
                .catch((error) => {
...
export const searchProductEpic = action$ =>
    action$.pipe(
        ofType(ActionEvent.SEARCH_PRODUCT),
        switchMap((action) =>
            fetch(ServerPath.API_URL + `product/search`, {
                ...
                console.log(responseJson)
                return productActions.searchProductSuccess(responseJson)
            })
                .catch((error) => {
                    consoleLogEpic("SEARCH_PRODUCT_EPIC:", ActionEvent.SEARCH_PRODUCT, error);
                    return handleConnectErrors(error)
                })
        )
    );
